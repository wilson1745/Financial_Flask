...
if __name__ == "__main__":
    ...
    try:
        ...
        line_notify.sendMsg([constants.SUCCESS % os.path.basename(__file__)], constants.TOKEN_NOTIFY)
    except Exception as e:
        CoreException.show_error(e, traceback.format_exc())
        line_notify.sendMsg([constants.FAIL % os.path.basename(__file__)], constants.TOKEN_NOTIFY)
    finally:
